...
public class HotelApp {
    ...
    public static void main(String[] args) {
        ...
        Hotel hotel2 = new Hotel("Grand Hotel", 23, 40, 5, 12);
        System.out.println("Hotel 2 available suites: " + hotel2.getAvailableSuites());
        System.out.println("Hotel 2 available rooms: " + hotel2.getAvailableRooms());
        System.out.println();

        employee1.punchTimeCard();
        employee1.punchTimeCard();


        System.out.println("\nWelcome BNY Hotel, would you like to check in? (Y/N)");
